...
async function main(): Promise<void> {
  ...
  if (args.length === 1 && (args[0] === '--version' || args[0] === '-v' || args[0] === '-V')) {
    ...
    console.log(`${MACRO.VERSION} (Local Agent)`);
    return;
  }
...
// Surface startup/runtime failures instead of letting an unhandled rejection
// disappear behind the fire-and-forget top-level entrypoint.
// eslint-disable-next-line custom-rules/no-top-level-side-effects
